...
/**
 * AccreditedSearch represents the model behind the search form of `common\models\Accredited`.
 */
class AccreditedSearch extends Accredited
{
    /**
     * {@inheritdoc}
     */
